...
async function checkHealth() {
    try {
        ...
        document.getElementById('dotOpenai').classList.toggle('active', data.apis.openai);
        ...
        if (!data.apis.openai || !data.apis.elevenlabs) {
    ...
    const pipelineHtml = chatMode === 'full' ? `
        <div class="pipeline-steps">
            <div class="pipeline-step active" id="${id}-step1">
                <span class="step-icon">🧠</span> Thinking with OpenAI...
            </div>
